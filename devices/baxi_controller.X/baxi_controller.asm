...
;<editor-fold defaultstate="collapsed" desc="Do_DecreaseLastRPiTm">
;**********************************************************************
...
SkipStuckState
    ...
    ; If we haven't got a signal for 45 seconds, we consider it stopped.
    movlw   45                  ; Reset BaxiRunTmr if
